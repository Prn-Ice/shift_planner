  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= ShiftPlannerBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= ShiftPlannerBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= ShiftPlannerBreakpoints.large) {
